-- ============================================================
-- AdFlow OS (legacy) — consolidated Supabase SQL reference
-- ============================================================
-- All root-level .sql files merged into one, in the order they were
-- meant to run: base schema -> feature migrations (alpha order) ->
-- security-hardening (last, per its own header requirement) ->
-- diagnostic/maintenance/reset utility scripts (run ad hoc, not in order).
-- These have already been applied to the live database; this file is a
-- historical reference, not something to re-run as-is.
--
-- The separately-maintained supabase/migrations/ directory (Supabase CLI
-- tracked history) is untouched and stays independent of this file.
-- ============================================================

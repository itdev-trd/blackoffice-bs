...
const VAGUE = ["", "-", "ไม่ทราบ", "ไม่พบประเทศ", "ไม่พบข้อมูลประเทศ",
  "ไม่สามารถระบุประเทศ", "ไม่สามารถระบุประเทศได้", "ภาษาอังกฤษ (ยังระบุประเทศไม่ได้)"];

// ประเทศเป้าหมายของแอด -> ชื่อไทย + ภาษาที่ใช้ตอบ (ให้ตรงกับที่ระบบแปลใช้อยู่)
const COUNTRY: Record<string, { name: string; lang: string }> = {
  // ชื่อสั้นให้ตรงกับ lib/constants/countries.js และกับที่ตัวซิงก์เขียน ("ไทย")
  // เดิมที่นี่เขียน "ประเทศไทย" ทำให้ประเทศเดียวกันแตกเป็นสองกลุ่มในตัวกรอง
  TH: { name: "ไทย", lang: "Thai" },

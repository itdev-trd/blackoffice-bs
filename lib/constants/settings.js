...
export const SETTINGS_SECTIONS = [
  ...
  { key: "chatmenu", label: "เมนูปุ่มในแชท", icon: MessageSquare, form: false },
  { key: "knowledge", label: "คลังคำถาม–คำตอบ", icon: Database, form: false },
  { key: "meta", label: "Meta Token", icon: SettingsIcon, form: false },
  { key: "crm_api", label: "API สำหรับแชร์ข้อมูล", icon: KeyRound, form: false },
  ...
  // สถานะ token/คุกกี้/ซิงก์/cron — เฉพาะ owner (เห็นว่า token หมดอายุเมื่อไหร่ = ข้อมูลความปลอดภัย)
  { key: "health", label: "สุขภาพระบบ", icon: HeartPulse, form: false },
  ...
  // ย้ายข้อมูลจากระบบเก่าผ่านไฟล์ Excel — งานครั้งเดียว แต่ต้องมีที่ให้กดได้
  { key: "import_old", label: "นำเข้าข้อมูลจากระบบเก่า", icon: Upload, form: false },
];

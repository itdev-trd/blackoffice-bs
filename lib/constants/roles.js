...
//
// tv_members ไม่ใช่เมนูในแถบข้าง (ถูกถอดออกไปแล้ว) แต่เป็น "คีย์สิทธิ์" ที่ edge function
// tradingview ใช้ตรวจ — ถ้าไม่มีคีย์นี้ แอดมินจะเพิ่มอินดี้ให้ลูกค้าไม่ได้เลย
export const ADMIN_TABS = [
  "overview", "inbox", "ad_chats", "feed", "customerdb", "customer_list", "leaderboard", "tv_members", "settings",
];
